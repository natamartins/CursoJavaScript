...
console.log("\nMeus amigos:");
// ?
var amigos = ["ralf", "betovem", "bili", "zeus", "ray"];
var phrase = amigos
...
var myNewName = [];
for (var i = 0, len = myName.length; 1 < len; i++) {
  myNewName.push(
    i % 2 === 0 ? myName[i].toLocaleLowerCase() : myName[i].toUpperCase()
  );
